        ...
        <div class="container">
            <div class="row new-account-login">
                <div class="col-sm-6 col-lg-6 mb-3">
                    ...
                    <h5><a data-toggle="collapse" href="#formLogin" role="button" aria-expanded="false">Click here to Login</a>
                    </h5>
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-6 mb-3">
                    <form class="needs-validation" method="post" action="{{ route('checkOut.process') }}" novalidate>
                        <div class="checkout-address">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    @error('username')
                                        <div class="invalid-feedback" style="width: 100%; display: block;"> {{ $message }}
                                        </div>
                                    @enderror
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="numbers" name="customer_phone" class="form-control" id="phone"
                                    placeholder="" required>
                                @error('phone')
                                    <div class="invalid-feedback"> Please enter your shipping address. </div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="numbers" name="note" class="form-control" id="note" placeholder=""
                                    required>
                                @error('note')
                                    <div class="invalid-feedback"> Please enter your shipping address. </div>
                                @enderror
                            </div>
                            <input type="hidden" name="total" value="{{$cart->getTotalPrice() - session('discount_amount_price')}}">
                            {{-- <div class="mb-3">
                    ...
                    <div class="row">
                                        ...
                                        <div class="media mb-2 border-bottom">
                                            <div class="media-body"> <a href="detail.html"> {{ $item->name }}</a>
                                                <div class="small text-muted">Price: $ {{ $item->price }} <span
                                                        class="mx-2">|</span> Qty: {{ $item->pivot->product_quantity }}
                                                    <span class="mx-2">|</span>
                                                    Subtotal: $ {{ $item->price * $item->pivot->product_quantity }}
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="order-box">
                                ...
                                <div class="d-flex">
                                    <h4>Sub Total</h4>
                                    <div class="ml-auto font-weight-bold" id="sub-total"
                                        data-price="{{ $cart->getTotalPrice() }}"> $
                                        {{ number_format($cart->getTotalPrice(), 0, '', ',') }}</div>
                                </div>
                                <div class="d-flex">
                                    <h4>Coupon Discount</h4>
                                    @if (session('discount_amount_price'))
                                        <div class="ml-auto font-weight-bold coupon-discount"
                                            data-price="{{ session('discount_amount_price') }}">$
                                            {{ session('discount_amount_price') }}</div>
                                    @else
                                        <div class="ml-auto font-weight-bold coupon-discount" data-price="0"> $ 0 </div>
                                    @endif
                                </div>
                                {{-- <hr class="my-1">
                                <div class="d-flex">
                                ...
                                <div class="d-flex gr-total">
                                    <h5>Grand Total</h5>
                                    <div class="ml-auto h5 grand-total"> $ 0 </div>
                                </div>
                                <hr>
                            </div>
                        </div>
